(function (factory) {
    ...
    function Chocolat(element, settings) {
        ...
        if (!this.settings.setCategory && element.data('chocolat-category')) {
            this.settings.setCategory = element.data('chocolat-category');
        }
    ...
    fit : function(i, container) {
        ...
        if ($(window).width() > 1025 && $(window).width() <= 1800 && $(window).height() > 670){
    ...
    arrows: function() {
        ...
        markup : function() {
            ...
            this.elems.setTitle = $('<span/>', {
                ...
                'html' : this.settings.setCategory
            }).appendTo(this.elems.top);
